...
public class rideSharing{
    ...
    public static void main(String[] args){
        ...
        System.out.println("Developed by Shreyang, 0123");
        ...
        do{
            ...
            switch(ch) {
                case 1:
                    ...
                    details.setKilometers(kilometers);
                    ...
                    System.out.println("Now enter the time of travel using 24 hour clock just like 9.00 for 9am, 13.00 for 1 pm, 14.30 for 2:30pm etc");
                    do{
                        time = sc.nextFloat();
                    }while(time < 0.00 ||time > 24.00);
                    details.setTime(time);

                    LocalDate localDate = LocalDate.of(year, months, day);
                    dayOfWeek = localDate.getDayOfWeek();
                    details.setDayOfWeek(dayOfWeek);
                ...
                case 2:
                    ...
                    kilometers = details.getKilometers();
                    float perKm = (float) 0.75;
                    float baseCharges = (float) 5.50;
                    float peakTimeCharge = (float) 2.50;
                    float weekendCharge = (float) 3.00;
                    dayOfWeek = details.getDayOfWeek();
                    System.out.println("Your travel details:- Day of the week on " + details.getDay() + " of the month - " + Month.of(details.getMonth()) + " is " + details.getDayOfWeek());
                    if(time >= 7.00 && time <= 9.00 || time >= 16.00 && time <= 18.00){
                        if (dayOfWeek.getValue() == 6 || dayOfWeek.getValue() == 7){
                            details.totalForCompany1 = baseCharges + kilometers * perKm + peakTimeCharge + weekendCharge;
                            ...
                            details.totalForCompany1 = baseCharges + kilometers * perKm + peakTimeCharge;
                            System.out.println("\nYour day of travels does not falls under weekend categories");
                            System.out.println("\nTime falls in peaktime category \n\nSo charges will be applied accordingly\n");
                        }
                    }
                    else{
                         details.totalForCompany1 = baseCharges + kilometers * perKm;
                    }
                    System.out.println("The final charges under OLA is: " + details.totalForCompany1);
                    for(int i=1; i<70; i++)
                    {
                        System.out.printf("*");
                    }
                ...
                case 3:
                    ...
                    if(time >= 7.00 && time <= 9.00 || time >= 16.00 && time <= 18.00){
                        if (dayOfWeek.getValue() == 6 || dayOfWeek.getValue() == 7){
                            details.totalForCompany2 = baseCharges2 + kilometers * perKm2 + peakTimeCharge2 + weekendCharge2;
                            System.out.println("\nYour day of travels does falls under weekend categories");
                            System.out.println("\nTime falls in peaktime category and it is weekend \n\nSo charges will be applied accordingly\n");
                        }
                        else{
                            details.totalForCompany2 = baseCharges2 + kilometers * perKm2 + peakTimeCharge2;
                            System.out.println("\nYour day of travels does not falls under weekend categories");
                            System.out.println("\nTime falls in peaktime category \n\nSo charges will be applied accordingly\n");
                        }
                    }
                    else{
                         details.totalForCompany2 = baseCharges2 + kilometers * perKm2;
                    }
                    System.out.println("The final charges under UBER is: " + details.totalForCompany2);
                    for(int i=1; i<70; i++)
                    {
                        System.out.printf("*");
                    }
                ...
                case 4:
                    ...
                    if(time >= 7.00 && time <= 9.00 || time >= 16.00 && time <= 18.00){
                        if (dayOfWeek.getValue() == 6|| dayOfWeek.getValue() == 7){
                            details.totalForCompany3 = baseCharges3 + kilometers * perKm3 + peakTimeCharge3 + weekendCharge3;
                            System.out.println("\nYour day of travels does falls under weekend categories");
                            System.out.println("\nTime falls in peaktime category and it is weekend \n\nSo charges will be applied accordingly\n");
                        }
                        else{
                            details.totalForCompany3 = baseCharges3 + kilometers * perKm3 + peakTimeCharge3;
                            System.out.println("\nYour day of travels does not falls under weekend categories");
                            System.out.println("\nTime falls in peaktime category \n\nSo charges will be applied accordingly\n");
                        }
                    }
                    else{
                         details.totalForCompany3 = baseCharges3 + kilometers * perKm3;
                    }
                    System.out.println("The final charges under RAPIDO is: " + details.totalForCompany3);
                    for(int i=1; i<70; i++)
                    {
                        System.out.printf("*");
                    }
                ...
                case 5:
                    ...
                    System.out.println("OLA: " + details.totalForCompany1);
                    System.out.println("UBER: " + details.totalForCompany2);
                    System.out.println("RAPIDO: " + details.totalForCompany3);
                    break;

                case 6:
                    System.out.println("Exit");
                    System.out.print("Thank you " + details.getName() + " for using the system \n All values have been resert to zero or null \n Good Bye......");
                    details.setDay(0);
                    details.setMonth(0);
                    details.setYear(0);
                    details.setKilometers(0);
                    details.setTime(0);
                    details.setDayOfWeek(null);
                    break;
